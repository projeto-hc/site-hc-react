        ...
        <>
            ...
            <main>
                <div className="bg-[#d9d9d9] flex flex-col p- space-y-2 p-8 justify-center ">
                    ...
                    <div className="bg-[#417571] w-50 h-50 border border-black rounded-xl flex flex-col lg:w-96 p-6 mx-auto">
                        <h2 className="font-bold text-white self-center lg: text-3xl">Precisa de ajuda?</h2>
